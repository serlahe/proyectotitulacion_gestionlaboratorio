...
async function seedUsuarios() {
    try {
        ...
        const usuarios = [
            { nombre: 'Administrador', correo: 'admin@lab.cl', password: 'admin123', id_rol: 1 },
            { nombre: 'Tecnologo Medico', correo: 'tecno@lab.cl', password: 'tecno123', id_rol: 2 },
            { nombre: 'Tecnico Laboratorio', correo: 'tecnico@lab.cl', password: 'tecnico123', id_rol: 3 }
        ];
